  ...
  return (
    <div className="relative min-h-screen w-full">
      ...
      <aside className="sidebar-layout custom-scrollbar">
        {/* Workspace Metadata Console */}
        <Section title="Workspace Status" titleExtra={usernameTag}>
          <div style={{ display: "flex", flexDirection: "column", gap: "0.75rem", fontSize: "0.8125rem", marginTop: "0.5rem" }}>
            <div style={{ display: "flex", justifyContent: "space-between", borderBottom: "1px solid var(--color-border)", paddingBottom: "0.5rem" }}>
              <span className="text-muted">Total Run Logs</span>
              <span style={{ fontWeight: 600 }}>{generations.length} generations</span>
            </div>
            <div style={{ display: "flex", justifyContent: "space-between", borderBottom: "1px solid var(--color-border)", paddingBottom: "0.5rem" }}>
              <span className="text-muted">DB Engine</span>
              <span style={{ fontWeight: 600, color: "#1a9e6e" }}>pgvector (pg16)</span>
            </div>
            <div style={{ display: "flex", justifyContent: "space-between", borderBottom: "1px solid var(--color-border)", paddingBottom: "0.5rem" }}>
        ...
        {/* Sidebar Console Branding & Navigation */}
      ...
      <div className="main-layout" style={{ maxWidth: "760px" }}>
        ...
        {generations.length === 0 ? (
          <div className="nm-card" style={{ textAlign: "center", padding: "3rem", width: "100%" }}>
